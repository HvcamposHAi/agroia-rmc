"""
AgroIA-RMC — Etapa 2: Coleta de Itens (v5 - PRODUÇÃO)
=====================================================
...
Execute: python etapa2_itens_v5.py
"""
...
DT_FIM = "31/12/2026"  # Atualizado para incluir 2026

# Configurações de execução
HEADLESS = False  # Headless não funciona com este portal JSF
SLOW_MO = 200     # Velocidade moderada para estabilidade
TIMEOUT = 60000   # Timeout em milissegundos
DELAY_ENTRE_PROCESSOS = 1.5   # Segundos entre processos
...
async def main():
    ...
    print("=" * 60)
    print("AgroIA-RMC — Coleta de Itens de Licitações (v5)")
    ...
    async with async_playwright() as p:
        ...
        # Argumentos para parecer navegador real e iniciar minimizado
        browser_args = [
