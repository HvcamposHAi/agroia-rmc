"""
AgroIA-RMC — Coleta Automática: Itens + Empenhos
================================================
Versão totalmente automática (sem interação manual).

Execute: python coleta_automatica.py
"""
import os
import re
import time
...
def extrair_empenhos_tabela(page):
    """Extrai empenhos da tabela visível."""
    empenhos = []
...
def preencher_filtros_e_pesquisar(page):
    """Preenche filtros automaticamente e pesquisa."""
    print("[2] Preenchendo filtros automaticamente...")
    
    # Selecionar órgão SMSAN/FAAC
...
def main():
    ...
    print("=" * 60)
    print("AgroIA-RMC — COLETA AUTOMÁTICA: ITENS + EMPENHOS")
    print("=" * 60)
    ...
    with sync_playwright() as p:
        ...
        if not preencher_filtros_e_pesquisar(page):
