"""
AgroIA-RMC — Diagnóstico Etapa 2 (v2)
=====================================
Identifica por que o scraper está retornando 0 processados.

Execute: python debug_etapa2_v2.py
"""
...
try:
    ...
    print("\n[!] python-dotenv não instalado. Instale com: pip install python-dotenv")

# Tentar obter variáveis
SUPABASE_URL = os.getenv("SUPABASE_URL")
SUPABASE_KEY = os.getenv("SUPABASE_KEY")

print(f"\nSUPABASE_URL definida: {bool(SUPABASE_URL)}")
print(f"SUPABASE_KEY definida: {bool(SUPABASE_KEY)}")

if not SUPABASE_URL or not SUPABASE_KEY:
    print("\n" + "=" * 60)
    print("SOLUÇÃO: Crie ou verifique o arquivo .env na pasta do projeto")
    print("=" * 60)
    print("""
...
2. Selecione o projeto AgroIA_RMC
3. Vá em Settings > API
4. Copie a "anon public" key
""")
    sys.exit(1)

# Se chegou aqui, as variáveis estão OK
...
if total == 0:
...
elif len(r_pendentes.data) == 0 and len(r_coletados.data) > 0:
    ...
    print("  Execute o SQL no Supabase para criar a coluna:")
